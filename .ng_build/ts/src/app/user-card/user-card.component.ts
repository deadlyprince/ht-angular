      ...
      <div class="text-left flex-row row-gap-10 flex">
        ...
        <div class="user-info-container">
          ...
          <ng-template [ngIf]="showStatus">
            ...
            <div class="flex-row text-muted user-status text-4">
          ...
          <div class="flex-row text-4" *ngIf="!user['segments']">
